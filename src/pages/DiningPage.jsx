...
const features = [
  "Elegant dining layouts",
  "Premium lighting concepts",
  "Luxury seating arrangements",
  "Modern wall detailing",
  "Warm ambiance planning",
  "Functional family spaces",
];

const gallery = [dining1, dining2, dining3, dining4];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-[#EDE6DD] text-base md:text-lg leading-8 mt-6 max-w-2xl">
              Premium dining interiors crafted with warmth, elegance, comfort,
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-[#5E5A57] leading-8 text-[16px] mt-7">
              We design elegant dining interiors that bring together comfort,
              warmth, and premium aesthetics for memorable everyday moments.
            </p>

            <p className="text-[#5E5A57] leading-8 text-[16px] mt-5">
              From lighting concepts to seating arrangements and modern
              finishes, every detail is crafted to create a sophisticated dining
              atmosphere.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -left-5 bg-[#FFFDF9] rounded-[22px] shadow-xl p-5 w-[220px] border border-[#E7DED5]">
              <h3 className="text-3xl font-bold text-[#2B2B2B]">Warm</h3>

              <p className="text-[#5E5A57] mt-2 leading-6 text-sm">
                Dining interiors designed for comfort, elegance, and family
                gatherings.
              </p>
            </div>
          </div>
      ...
      <section className="pb-16 px-6 md:px-10 bg-[#FAF7F2]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-[#5E5A57] leading-8 text-[16px] mt-5">
              Explore elegant dining interiors crafted with premium materials,
              modern aesthetics, and warm sophisticated styling.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto bg-[#2F241F] rounded-[32px] px-8 md:px-10 py-14 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[#EDE6DD] text-[16px] leading-8 max-w-3xl mx-auto mt-6">
              Transform your dining area into a premium modern space crafted
              with warmth, elegance, and timeless luxury.
            </p>
