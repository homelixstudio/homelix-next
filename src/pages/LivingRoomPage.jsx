...
import living1 from "../assets/livingroom-1.jpg";
import living2 from "../assets/livingroom-2.jpg";
import living3 from "../assets/livingroom-3.jpg";
import living4 from "../assets/livingroom-4.jpg";

const features = [
  "Luxury TV unit concepts",
  "Ambient modern lighting",
  "Premium furniture layouts",
  "Elegant wall panel designs",
  "Smart space utilization",
  "Warm modern aesthetics",
];

const gallery = [living1, living2, living3, living4];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-[#EDE6DD] text-base md:text-lg leading-8 mt-6 max-w-2xl">
              Premium living room interiors designed to blend warmth,
              sophistication, comfort, and timeless modern luxury.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-[#5E5A57] leading-8 text-[16px] mt-7">
              The living room is the heart of your home. We create elegant
              interiors that combine premium aesthetics, functional layouts,
              comfort, and timeless sophistication.
            </p>

            <p className="text-[#5E5A57] leading-8 text-[16px] mt-5">
              From statement TV units to warm lighting, luxurious textures, and
              modern furniture planning, every detail is thoughtfully crafted
              for modern living.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -left-5 bg-[#FFFDF9] rounded-[22px] shadow-xl p-5 w-[220px] border border-[#E7DED5]">
              <h3 className="text-3xl font-bold text-[#2B2B2B]">Elegant</h3>

              <p className="text-[#5E5A57] mt-2 leading-6 text-sm">
                Personalized living spaces crafted with warmth and luxury.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#2B2B2B]">
              Modern Luxury Concepts
            </h2>

            <p className="text-[#5E5A57] leading-8 text-[16px] mt-5">
              Explore elegant living room interiors crafted with luxury
              materials, modern layouts, and timeless aesthetics.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto bg-[#2F241F] rounded-[32px] px-8 md:px-10 py-14 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[#EDE6DD] text-[16px] leading-8 max-w-3xl mx-auto mt-6">
              Let’s transform your living room into a premium modern space
              crafted with comfort, elegance, and timeless luxury.
            </p>
